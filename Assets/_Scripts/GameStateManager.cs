...
public class GameStateManager : MonoBehaviour
{
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        if (ratGO != null)
        {
            ...
            if (CameraControlManager.Instance != null)
            {
                CameraControlManager.Instance.UpdateTarget(ratGO.transform);
            }
        }
        else
        {
        ...
        if (isRespawning)
        {
            ...
            if (CameraControlManager.Instance != null)
            {
                if (CameraControlManager.Instance.deathZoomCoroutine != null)
                {
                    CameraControlManager.Instance.StopCoroutine(CameraControlManager.Instance.deathZoomCoroutine);
                    CameraControlManager.Instance.deathZoomCoroutine = null;
                }
            }
        }
        else
        ...
        if (CameraControlManager.Instance != null)
        {
            ...
            CameraControlManager.Instance.ResetYawOnRespawn();
            CameraControlManager.Instance.ResetCameraAfterRespawn();
        }
